...
export const CHANGELOG = [
  ...
  },
  {
    ...
    date: '2026-08-29',
    notes: [
      'Fixed exploding right after a respawn (races and battles): after crashing into the ground, a network-timing race could make the client treat the server\'s not-yet-respawned state as a fresh kill — an instant explosion at the spawn, sometimes several in a row, each counted as a death. Respawns are clean now.',
    ],
  },
  {
    version: '1.2.2',
  ...
  },
  {
    ...
    date: '2026-06-28',
    notes: [
      'Menu polish: the showcased aircraft no longer gets clipped by an invisible edge as it spins (the camera now frames the whole plane at every angle), changing aircraft plays a smooth slot-machine roll, and the race lobby now spins the lead-voted plane in 3D just like the main menu.',
    ],
  },
  {
    version: '0.7.3',
  ...
  },
  {
    ...
    date: '2026-06-14',
    notes: [
      'Fixed the shimmering/flickering river banks near mountains — the new reflective river water was z-fighting against steep slopes; it now sits cleanly inside its banks.',
    ],
  },
  {
    version: '0.6.10',
...
// Only the STATIC world casts into the throttled sun shadow map now (the plane
// uses the always-smooth blob shadow and no longer casts into it), so a coarse
// 6 m refresh is invisible (terrain shadows don't move) and keeps the GPU win.
